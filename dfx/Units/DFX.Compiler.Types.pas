...
type
  ...
  public
    ...
    function UQuerySRV(const Obj: string): string;
    function UQuerySamplerState(const Obj: string): string;
    function UQueryConstantBuffer(const Obj: string): string;
    function UQueryShader(const Obj: string): string;
    function UQueryUAV(const Obj: string; UAVIndex: Integer): string;
    function UResourceTypeFromHLSL(const HLSLType: string): string;
...
function TDFXCppTranslator.UQueryConstantBuffer(const Obj: string): string;
begin
  Result := LuaQuery('query_constant_buffer', [Obj]);
end;

function TDFXCppTranslator.UQuerySamplerState(const Obj: string): string;
begin
  Result := LuaQuery('query_sampler_state', [Obj]);
end;

function TDFXCppTranslator.UQueryShader(const Obj: string): string;
begin
  Result := LuaQuery('query_shader', [Obj]);
end;

function TDFXCppTranslator.UQuerySRV(const Obj: string): string;
begin
  Result := LuaQuery('query_srv', [Obj]);
end;

function TDFXCppTranslator.UQueryUAV(const Obj: string; UAVIndex: Integer): string;
begin
  Result := LuaQuery('query_uav', [Obj, IntToStr(UAVIndex)]);
end;

function TDFXCppTranslator.UResourceTypeFromHLSL(const HLSLType: string): string;
begin
  Result := LuaQuery('resource_type_from_hlsl', [HLSLType]);
end;
