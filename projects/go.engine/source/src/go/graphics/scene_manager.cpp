...
// ================================================================================ //
// go::gfx_scene_manager member functions
// ================================================================================ //

go::gfx_scene_manager::gfx_scene_manager(go::cdefault_value)
{
...
void go::gfx_scene_manager::reset(const gfx_asset_context_parameters &assetContextParameters)
{
    m_scenes.clear();
...
go::gfx_scene *go::gfx_scene_manager::create_scene()
{
    m_scenes.push_back(std::make_unique<gfx_scene>(this));
    return m_scenes.back().get();
}


void go::gfx_scene_manager::destroy_scene(gfx_scene *scn)
{
...
void go::gfx_scene_manager::render(size_t index)
{
...
void go::gfx_scene_manager::update()
{
