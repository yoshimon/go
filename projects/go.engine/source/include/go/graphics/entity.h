...
/*!
    \file graphics/entity.h
    \brief Contains a class that represents an entity in the graphics world.
...
typedef uint32_t gfx_entity_id;
typedef std::vector<gfx_entity_id> gfx_entity_id_vector;

class gfx_scene;
class gfx_entity_component_manager;
...
public:
     ...
     */
    GO_API operator gfx_entity_id() const noexcept { return m_id; };
public:
    /*!
        ...
        \return The entity identifier.
     */
    GO_API gfx_entity_id id() const noexcept { return m_id; }
    /*!
     ...
     */
    GO_API void _change_scene(gfx_scene *scene) noexcept { m_scene = scene; }
    /*!
        Detaches all compnoent from the entity.
...
private:
    ...
    std::array<gfx_entity_component_manager *, GO_ENTITY_MAX_COMPONENT_COUNT> m_componentManagers;
    //! The scene pointer.
    gfx_scene *m_scene = nullptr;
};
