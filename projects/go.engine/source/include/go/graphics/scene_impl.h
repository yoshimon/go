...
ComponentManager *gfx_scene::register_entity_component_manager(size_t componentCountHint, Args &&... args)
{
...
ComponentManager *gfx_scene::find_entity_component_manager()
{
